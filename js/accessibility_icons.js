...
const AguiaIcons = {
    ...
    colorblindNone: '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><title>Sem filtro de daltonismo</title><path fill="currentColor" d="M2.47 2.47c-.39.39-.39 1.02 0 1.41l2.26 2.26A9.91 9.91 0 0 0 2 12c0 5.52 4.48 10 10 10 2.04 0 3.93-.63 5.49-1.69l2.69 2.69c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L3.87 2.47c-.38-.39-1.01-.39-1.4 0zM12 20c-4.42 0-8-3.58-8-8 0-1.48.42-2.85 1.13-4.03l10.9 10.9c-1.18.71-2.55 1.13-4.03 1.13zm4.51-9.03l-2.9-2.9c1.3-.51 2.73.18 3.25 1.48.22.53.22 1.12 0 1.66-.1.23-.22.44-.35.63zm.03 6.5l-7-7c0-.01-.01-.02-.01-.03a2.99 2.99 0 0 1 4.64-2.5l.01-.01 2.49 2.49-.01.01c.18.56.18 1.16 0 1.72l-.01.01.01.01c-.3.94-1.06 1.62-2.03 1.84l-.03-.03-1.73-1.73c.01 0 .02-.01.04-.01a.79.79 0 1 0-.56-1.36l-.57-.57a.778.778 0 0 0-.38 1.45c.16.07.33.09.5.07l1.74 1.74c-.08 0-.16.02-.24.02-1.25 0-2.26-.93-2.36-2.15l-2.49-2.49c-.18-.56-.19-1.16-.01-1.73l.01-.01-.01-.01c.17-.55.49-1.04.97-1.39l-1.01-1.01c-1.3.9-2.12 2.37-2.12 4.02 0 3.04 2.46 5.5 5.5 5.5 1.65 0 3.11-.73 4.12-1.88z"/></svg>',
    
    protanopia: '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><title>Protanopia</title><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1" fill="#FF0000"/></svg>',
    
    deuteranopia: '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><title>Deuteranopia</title><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1" fill="#00FF00"/></svg>',
    
    tritanopia: '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><title>Tritanopia</title><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1" fill="#0000FF"/></svg>',
    
    achromatopsia: '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><title>Monocromacia</title><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1" fill="#000000"/></svg>',
